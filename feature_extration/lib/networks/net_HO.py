...
class ResNet50():
    ...
    def build_network(self, is_training):
        ...
        fc7_H, fc7_O = self.res5(pool5_H, pool5_O, is_training, 'Crop_R')
        
        self.features['H']  = fc7_H
        self.features['O']  = fc7_O
    ...
    def get_HO(self, sess, image, blobs):
        feed_dict = {self.image: image, self.H_boxes: blobs['H_boxes'], self.O_boxes: blobs['O_boxes']}
        fc7_H, fc7_O = sess.run([self.features['H'], self.features['O']], feed_dict=feed_dict)
        return fc7_H, fc7_O
