...
# __C.TRAIN.LEARNING_RATE = 0.0002 #0.00001
...
__C.WEIGHT_DIR = "/Disk2/hongwei/hat-weights/"#__C.ROOT_DIR + "/Weight/"
...
__C.PASTA_LANGUAGE_MATRIX_PATH = osp.abspath(osp.join(__C.ROOT_DIR, 'lib', 'ult'))
__C.PASTA_WEIGHTS_PATH = osp.abspath(osp.join(__C.DATA_DIR, 'freqs_and_weights'))
